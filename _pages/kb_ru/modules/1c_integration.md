...
- _**Импортировать значения реквизитов**_ - В "1С:предприятие" необходимо создать реквизиты (дата, номер заказа и т.д.) для настройки синхронизации заказов. Значения реквизитов будут перенесены в магазин в виде атрибутов товаров.
