...
<a id="cloudsearch-dashboard"></a>
Модуль предоставляет панель мониторинга (**Dashboard**), где администратор магазина может просматривать информацию об учетной записи магазина в отношении использования службы CloudSearch:
