...
В **X-Cart Всё включено** модуль уже установлен и требует {% link "активации" ref_IEo2gFuZ %}. 

![1.png]({{site.baseurl}}/attachments/ref_17GXlKju/1.png)

Для **X-Cart Базовый**, **Бизнес** и **Мультивендор** модуль необходимо {% link "приобрести в маркетплейсе, установить и активировать" ref_gpeZtm28 %}.
