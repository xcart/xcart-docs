...
---
{% note info %}
Функциональность импорта заказов является частью функциональности бесплатного модуля [Orders Import](https://market.x-cart.com/addons/orders-import.html). Модуль не входит в дистрибутив X-Cart и устанавливается отдельно.
{% endnote %}
...
<table class="ui celled padded compact small table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="1" class="confluenceTd">Розничная цена товара.</td>
