...
updated_at: '2017-11-16 15:51 +0400'
identifier: ref_2tRcco06
title: 'Импорт CSV: Классы и атрибуты '
order: 20
published: true
---
В таблице представлены поля и их содержание для импорта классов и атрибутов товаров.
...
<table class="ui celled padded compact small table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="1" class="confluenceTd">
        <p>Артикул товара, если это специальный атрибут товара. Если это глобальный атрибут, не заполняйте поле.</p>
      </td>
