...
Например, цену продукта  _12033 Форменные Поло Звездный Путь_ нужно снизить с RUB 500 до RUB 400, а для продукта _12032 Форменная Футболка Звездный Путь_: Следующее поколение нужно увеличить размер запаса с 11 до 15. Для начала рассмотрим случай, когда это простые продукты без опций и вариантов.
