...
3.  На странице **Глобальные атрибуты** указан класс, к которому принадлежит продукт.:
    ...
    Если класс не задан, или продукт должен входить в другой класс, {% link "выберите нужный класс" ref_oNqyWK0N#выбор-класса-для-продукта %} в меню и нажмите **Сохранить**.
