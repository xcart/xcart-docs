...
Если покупатель зарегистрирован в магазине, на этой странице он может войти в учётную запись (при {% link "разметке страницы" ref_theme %} _Стандартный_, _Fashion_, _Noblesse_, _Digital_). Если не зарегистрирован - учётная запись будет создана после оформления заказа на основании указанных контактных данных: 
