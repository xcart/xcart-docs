...
**Следуйте данным инструкциям по апгрейду магазина:**
   ...
   3.  Проверьте доступные обновления и выберите те, которые хотите установить. Если доступны оба вида апгрейда - полный и неполный - перейдите на соответствующую вкладку:
