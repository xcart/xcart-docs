...
*   [Обновление на новую версию (апгрейд) и обновление текущей версии](#обновление-на-новую-версию-апгрейд-и-обновление-текущей-версии)
*   [Волны апгрейда](#волны-апгрейда) 
*   [Доступность обновления для разных версий](#доступность-обновления-для-разных-версий)
*   [Специальные средства апгрейда (хуки)](#специальные-средства-апгрейда-хуки)
*   [До апгрейда: сохранение бэкапа магазина](#до-апгрейда-сохранение-бэкапа-магазина)
*   [Процесс апгрейда](#процесс-апгрейда)
*   [Апгрейд вручную](#апгрейд-вручную)

## Обновление на новую версию (апгрейд) и обновление текущей версии

Обозначение версии X-Cart включает [4 числовых элемента](http://devs.x-cart.com/en/misc/x-cart_versions.html#x-cart-53x-versioning) (статья на английском языке): два первых числа обозначают мажорную версию, третье число обозначает минорную версию, четвертое - версию билда (версии, в которой из нового - только исправленные баги). В соответствие с таким обозначением версий, процесс апгрейда имеет два вида:
...
**Следуйте данным инструкциям по апгрейду магазина:**
  ...
  ![19.jpg]({{site.baseurl}}/attachments/ref_sn9tuAyV/19.jpg)
   ...
   10.  Если на странице появились замечания по апгрейду, обязательно следуйте предложенным ниструкциям.  
...
*   [X-Cart Upgrade General Steps](http://devs.x-cart.com/en/misc/x-cart_upgrade_general_steps.html) (статья на английском языке)
*   [Upgrade hooks](http://devs.x-cart.com/en/misc/upgrade_hooks.html) (статья на английском языке)
