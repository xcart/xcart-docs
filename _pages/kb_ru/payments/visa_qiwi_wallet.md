...
## Регистрация в Visa QIWI Wallet
...
Затем покупатель нажимает **Разместить заказ** и переходит на сайт **QIWI** для оформления платежа.

После успешной оплаты покупатель возвращается в магазин на страницу информации о заказе.

![17.jpg]({{site.baseurl}}/attachments/ref_6VdyEdlr/17.jpg)
