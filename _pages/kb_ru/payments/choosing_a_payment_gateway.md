...
Для одних платёжных сервисов  необходим коммерческий счёт, для других - нет. Сервисы, требующие счёт продавца, предлагают выгодные условия выплаты комиссии (например, 2,3% в ROBOKASSA) и сгруппированные по категориям ежемесячные платежи. Для компании это означает сохранение большей части выручки. 
