...
Чтобы предлагать свои товары на единой торговой площадке, продавцу необходимо зарегистрироваться в магазине. Заявку на регистрация можно подать по ссылке **Become a seller** в магазине, заявка будет принята или отклонена администратором. Также, администратор может сам {% link "создать учётную запись продавца" ref_2VIZjv0i %} в разделе **Пользователи**.  
