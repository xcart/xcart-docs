...
| WFA | Ожидает одобрения | Статус присваивается заказу после оплаты нематериального товара, если в настройках модуля **E-Goods** активирована опция _Одобрение перед предоставлением доступа на скачивание_.|
