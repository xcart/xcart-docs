...
For merchants based in the US, Canada and the EU there is an option to set up automated tax calculation with a free {% link "AvaTax" ref_6880bVvi %} intagration. Merchant from the US can also use the or {% link "TaxJar" ref_0wHdWryq %} integration to automate tax calculcation.
