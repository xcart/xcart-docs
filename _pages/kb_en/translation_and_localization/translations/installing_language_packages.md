...
Hence if any translation you installed in the store is not full you can finalize it by editing a respective text label or by changing the text for the chosen directly in the store interface.
