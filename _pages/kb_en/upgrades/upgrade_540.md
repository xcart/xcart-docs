...
---
Once per day, each X-Cart store checks the X-Cart App Store for updates, the response being cached for 24 hours. If you need to delete this cache, open the link `<YOUR_STORE_URL>/service.php?/clear-cache`.
