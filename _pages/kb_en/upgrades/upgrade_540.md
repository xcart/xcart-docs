...
After you have selected to proceed with either minor or major software upgrades, check if there are any warnings from the {% link "X-Cart Service Screen" ref_5Br376jE %}, like on the screen below:
   ...
   *   If you are using an X-Cart trial copy without any license key activated or your access to upgrades has expired, you will not be able to continue any further than this step. If you see a warning like that, you need to purchase and activate a paid license. Once you do so, the problem will be resolved.
