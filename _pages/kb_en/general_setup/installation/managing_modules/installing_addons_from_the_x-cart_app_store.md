...
1.  Log in to your store's Admin area and click **My addons** in the Admin menu.
    ...
    You will be redirected to the **My Addons** section of the {% link "X-Cart Service Screen" ref_5Br376jE %}, where you will see a list of addons installed in your X-Cart store.
    ![mktplce_myaddons_.png]({{site.baseurl}}/attachments/ref_Vn1mMUw9/mktplce_myaddons_.png)

2. Use the Search box at the top of the main menu to search through the X-Cart App Store for the addon you require. 
