...
2. Anti-fraud protection
   ...
   As an additional means of protection, do not allow anonymous checkout. You can engage customers in registering an account with your store using the addon {% link "Register On Checkout" ref_1IYxME8O %}. 
