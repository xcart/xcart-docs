...
Starting from X-Cart v5.3.5.5 it's possible to define what encoding standard is used to generate Clean URLs - Inicode or Latin symbols - using the **use_unicode** setting value:
