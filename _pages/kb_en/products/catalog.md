...
If you still need to keep the checkout working but hide the product prices only the Catalog module functionality can be extended with the following modules:
