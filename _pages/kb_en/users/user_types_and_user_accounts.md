...
Sometimes the administrator may need to check how the store looks and functions for another user, or to do some task for them. In this case, the administrator can use the "Operate as this user" feature. To use this feature, open the profile of the user as whom you want to operate and select the option _Log in as this admin_ / _Operate as this customer_ from the Profile actions drop-down.
