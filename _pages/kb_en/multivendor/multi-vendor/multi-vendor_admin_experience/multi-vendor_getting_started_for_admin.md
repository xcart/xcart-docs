...
The store administrator should specify their preferences related to vendor payout requests. This can be done via the Finance section of the {% link "Multi-vendor addon settings page" ref_nFq48dhr %}.
