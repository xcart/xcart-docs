...
The store administrator should also check and adjust the Privacy and access settings on the {% link "Multi-vendor addon settings page" ref_nFq48dhr %} specifying their preferences as to whether the customers' contact information may be shown to vendors, whether the vendors should have access to global attributes, whether the vendors should be allowed to work with product ratings and reviews, and so on.

## Step: Adjust the vendor onboarding message
