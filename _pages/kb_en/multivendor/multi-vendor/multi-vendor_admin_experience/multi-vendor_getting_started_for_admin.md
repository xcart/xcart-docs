...
The store administrator should specify how they wish to work with vendor payout requests. This can be done via the Finance section of the {% link "Multi-vendor addon settings page" ref_nFq48dhr %}.
