...
If this option is enabled, the messages from the customers will be addressed to individual vendors. If disabled, all the messages will go to the store administrator.
