...
2. In the popup, click inside the input field and specify up to five search queries that you want to be treated as synonymous (You must enter at least two words or phrases.) To enter multiple search queries, separate the individual queries with commas (,) or press ENTER after each query as you type.
