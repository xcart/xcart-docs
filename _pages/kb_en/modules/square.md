...
4. Complete your Square app setup and obtain the information you require for connection.
   ...
   You need to switch this API version to the version recommended on the Square addon settings page in your X-Cart store Admin area (See further below how to find this page). To switch the API version, use the button **Change Version**.
