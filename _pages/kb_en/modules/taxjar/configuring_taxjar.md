...
published: true
---
To install the addon TaxJar, follow the general instructions from {% link "Installing Addons from the Marketplace" ref_Vn1mMUw9 %}.
